...
if (ToolBar_Supported)
{
	...
	if (!RTL){
		//HTMLStr = "<DIV ID='idToolbar'     STYLE='background-color:white;width:100%'>";
		//HTMLStr += "<DIV ID='idRow1'        STYLE='position:relative;height:20px;'>";
		HTMLStr += "<DIV ID='idICPBanner'   STYLE='position:absolute;top:0px;left:0px;height:58px;width:200px;overflow:hidden;vertical-align:top;'><!--BEG_ICP_BANNER--><!--END_ICP_BANNER--></DIV>";
		HTMLStr += "<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0px;left:100px;height:20px;width:18px;overflow:hidden;vertical-align:top;'><IMG SRC='/cmsnews/admin/images/curve.gif' BORDER=0></DIV>";
		...
		HTMLStr += "<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:100;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='/library/toolbar/iw/images/curve.gif' BORDER=0></DIV>";
...
function drawToolbar()
{
	...
	MSMenuWidth     = Math.max(idMSMenuPane.offsetWidth, (200+260)); //200+260 do dai cua menu
